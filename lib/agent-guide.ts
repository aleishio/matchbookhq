...
export const AGENT_GUIDE: AgentGuide = {
  ...
  firstTask: [
    ...
    "Call list_approval_events and choose an eventId; prefer kind=real and guestAdds=available for any live write.",
    "Call get_event_prep_context with the chosen eventId and pageSize=5 to sample founder/event-prep context.",
    "Call list_approval_queue with the chosen eventId and pageSize=5 if approval events exist.",
    "Call get_approval_summary only after list_approval_queue returns an applicationId.",
